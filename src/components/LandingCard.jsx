        ...
        <div className="md:grid md:grid-cols-6">
            <div className="md:col-span-3">
                <div className=" px-10 md:pl-40 mb-4">
                    <p className="text-neutral-800  font-semibold font-poppins text-4xl pt-10 mb-1 md:mb-3 md:text-5xl md:pt-28">
                    ...
                    <Typewriter
                        options={{
                            ...
                            autoStart: true,
                            loop: true,
                            wrapperClassName: " text-neutral-800 text-3xl md:text-5xl font-semibold font-poppins"
                        }}
                    />
                    ...
                    <div className="flex font-montserrat md:gap-3">
                        <button type="button" className="flex px-1 py-2 md:px-4 md:py-2.5 text-base font-semibold text-center text-white bg-blue-500 rounded-md md:hover:px-7 transform duration-300 hover:bg-blue-600">
                        ...
                        <button onClick={scrollToProductInfo} type="button" className="group  px-1 py-2 md:px-4 md:py-2  flex items-center text-gray-900 text-base hover:text-white border border-gray-800 hover:bg-gray-900 font-medium rounded-lg md:hover:px-7 transform duration-300 text-center me-2 ">
                            Our Products
            ...
            <div className="hidden lg:block lg:col-span-3 lg:text-black lg:overflow-hidden">
                <div class="relative flex justify-center items-center overflow-hidden w-full h-96">
                    ...
                    <img src="phone.gif" alt="Overlay Image" className="absolute -bottom-4 md:-left-32 lg:-left-42 2xl:-left-52 w-4/5" />
                </div>
            </div>
        </div>
